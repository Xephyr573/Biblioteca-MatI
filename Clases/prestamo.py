...
# Importar "datetime" sirve tanto para agregarle el tiempo, como para tambien generar un codigo que nos ayude para facilitar los dias del prestamo dados, hasta el tiempo de finalización de este mismo.
