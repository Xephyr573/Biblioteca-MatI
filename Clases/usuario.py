...
# Se agrega un import llamado "rut_chile", que instalaremos de manera externa en la terminal como "pip", para que asi podamos agregar o controlar el rut de un usuario.
# Volvemos a utilizar el "re" que ya fue explicado en otra sub clase.
