...
# Importamos "re" (RegEx) que es una secuencia de caracteres que forma un patrón de búsqueda.  

# "RegEx" se utiliza para comprobar si una cadena contiene el "patrón de búsqueda especificado".
